...
After dashboard submit, the session-activity panel shows the bounded queued count, pending agent work, dry-run replies, stale/rejected states, and execution receipts, while affected rows show they were sent to the agent.
